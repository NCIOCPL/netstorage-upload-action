...
const Auth = __webpack_require__(8117)
const Parser = __webpack_require__(4554)
...
class Requestor {
  ...
  makeRequest(requestArgs, callback) {
    ...
    if (requestArgs.action.indexOf('upload') >= 0) {
      try {
...
const fs = __webpack_require__(5747)
const path = __webpack_require__(5622)
const APIRequest = __webpack_require__(4774)
...
class Netstorage {
  ...
  upload(local_source, ns_destination, index_zip, callback) {
    ...
    return this.requestor.makeRequest({
      action: 'upload' + (index_zip === true ? '&index-zip=1' : ''),
      method: 'PUT',
      source: local_source,
      path: ns_destination
    },
...
const run = __webpack_require__(8989);
...
const Netstorage = __webpack_require__(5049);
...
const path = __webpack_require__(5622);
const NetstorageAsync = __webpack_require__(9424);
